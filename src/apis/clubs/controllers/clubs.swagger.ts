...
export const ApiClub: ApiOperator<keyof ClubsController> = {
  ...
  PatchUpdateClubPost: function (
    ...
    return applyDecorators(
      ...
      DetailResponseDto.swaggerBuilder(HttpStatus.OK, 'clubPost', ClubPostDto),
      HttpException.swaggerBuilder(
        HttpStatus.BAD_REQUEST,
        [
          COMMON_ERROR_CODE.INVALID_REQUEST_PARAMETER,
  ...
  FindAllAndCountClubPostComments: function (
    apiOperationOptions: Required<Pick<Partial<OperationObject>, 'summary'>> &
      Partial<OperationObject>,
  ) {
    return applyDecorators(
  ...
  RemoveClubPostComment: function (
    apiOperationOptions: Required<Pick<Partial<OperationObject>, 'summary'>> &
      Partial<OperationObject>,
  ): PropertyDecorator {
    return applyDecorators(
      ...
      DeleteResponseDto.swaggerBuilder(HttpStatus.OK, 'clubPostComment'),
      HttpException.swaggerBuilder(
        HttpStatus.BAD_REQUEST,
        [COMMON_ERROR_CODE.INVALID_REQUEST_PARAMETER],
        {
  ...
  PatchUpdateClubReview: function (
    apiOperationOptions: Required<Pick<Partial<OperationObject>, 'summary'>> &
      Partial<OperationObject>,
  ): PropertyDecorator {
    return applyDecorators(
  ...
  RemoveClubReview: function (
    ...
    return applyDecorators(
      ...
      DeleteResponseDto.swaggerBuilder(HttpStatus.OK, 'count'),
      HttpException.swaggerBuilder(
        HttpStatus.BAD_REQUEST,
        [COMMON_ERROR_CODE.INVALID_REQUEST_PARAMETER],
        {
